...
namespace MultiTenancy {
  ...
  public class EnumActionDto {
    ...
    public T ToEntity<T>() where T : IEnumEntity, new() {
      var e = new T();
    ...
    public static T ToEntity<T>(string name) where T : IEnumEntity, new() {
      return new EnumActionDto { Name = name }.ToEntity<T>();
    }
  }
